...
namespace BulkyWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult ShipOrder()
        {
            ...
            var orderHeader = _unitOfWork._orderHeaderRepository.Get(u => u.Id == OrderVM.OrderHeader.Id);
        ...
        {
            OrderVM.OrderHeader = _unitOfWork._orderHeaderRepository
                .Get(u => u.Id == OrderVM.OrderHeader.Id, includeProperties: "ApplicationUser");
            OrderVM.OrderDetail = _unitOfWork._orderDetailRepository
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
            {
                ...
                if (session.PaymentStatus.ToLower() == "paid")
                {
                    ...
                    _unitOfWork._orderHeaderRepository.UpdateStatus(orderHeaderId, orderHeader.OrderStatus, SD.PaymentStatusApproved);
                    _unitOfWork.Save();
                }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                objOrderHeaders = _unitOfWork._orderHeaderRepository.GetAll(includeProperties: "ApplicationUser").ToList();
            }
            else
            {
                ...
                objOrderHeaders = _unitOfWork._orderHeaderRepository
